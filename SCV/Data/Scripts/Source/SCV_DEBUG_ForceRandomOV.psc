ScriptName SCV_DEBUG_ForceRandomOV Extends ActiveMagicEffect
...
Event OnEffectStart(Actor akTarget, Actor akCaster)
  ...
  If Victim
    ...
    If Success
      If Setting_Lethal
        SCV_SwallowLethal.Cast(akTarget, Victim)
      Else
        SCV_SwallowNonLethal.Cast(akTarget, Victim)
      EndIf
    EndIf
  Else
...
Function Note(String sMessage)
  Debug.Notification("[SCV Debug: FROV] " + sMessage)
EndFunction
