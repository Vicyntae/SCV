...
Int Function insertPreyAsync(Actor akPred, Actor akPrey, Int aiItemType, Bool abFriendly, Bool abPlayAnimation)
  ...
  While !Future
    if !thread01.queued()
      thread01.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 1
    ElseIf !thread02.queued()
      thread02.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 2
    ElseIf !thread03.queued()
      thread03.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 3
    ElseIf !thread04.queued()
      thread04.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 4
    ElseIf !thread05.queued()
      thread05.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 5
    ElseIf !thread06.queued()
      thread06.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 6
    ElseIf !thread07.queued()
      thread07.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 7
    ElseIf !thread08.queued()
      thread08.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 8
    ElseIf !thread09.queued()
      thread09.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 9
    ElseIf !thread10.queued()
      thread10.setThread(akPred, akPrey, aiItemType, abFriendly, abPlayAnimation)
      Future = 10
    Else
      begin_waiting()
    EndIf
