...
String Property DebugName
  String Function Get()
    Return "[SCVSwallow " + PredName + ", " + PreyName + "] "
  EndFunction
EndProperty
...
Event OnEffectStart(Actor akTarget, Actor akCaster)
  ...
  Notice("Swallow spell cast! Pred=" + PredName + ", Prey=" + PreyName)
...
Float Function calculateChance(Actor akPred, Actor akPrey)
  ...
  Int PredSkill = SCVLib.getOVLevelTotal(akPred, PredData)
  Int PreySkill = SCVLib.getResLevel(akPrey, PreyData)
  Float PredHealthPercent = akPred.GetActorValuePercentage("Health")
  Float PreyHealthPercent = akPrey.GetActorValuePercentage("Health")
