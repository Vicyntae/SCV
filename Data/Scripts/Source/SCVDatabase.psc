...
Function setupSCA(Int JFD_Items)
  ;/If !SCVSet.SCALib
    SCVSet.SCALib = Game.GetFormFromFile(0x03000d62, "SCA.esp") as SCALibrary
  EndIf

  If !SCVSet.SCASet
    SCVSet.SCASet = Game.GetFormFromFile(0x03000d63, "SCA.esp") as SCASettings
  EndIf

  If !SCVSet.SCAData
    SCVSet.SCAData = Game.GetFormFromFile(0x03000d64, "SCA.esp") as SCADatabase
  EndIf

  If !SCVSet.SCAMCM
    SCVSet.SCAMCM = Game.GetFormFromFile(0x03000d65, "SCA.esp") as SCAModConfig
  EndIf/;
  SCLibrary.addItemType(6, "Breaking Down (Anus)", "Prey breaking down in the anus.", "", False)
  SCLibrary.addItemType(7, "Breaking Down (Bladder)", "Prey breaking down in the bladder.", "", False)
EndFunction

Function removeSCA(Int JFD_Items)
  ;/SCVSet.SCALib = None
  SCVSet.SCASet = None
  SCVSet.SCAData = None
  SCVSet.SCAMCM = None/;
  SCLibrary.removeItemType(6)
  SCLibrary.removeItemType(7)
EndFunction
